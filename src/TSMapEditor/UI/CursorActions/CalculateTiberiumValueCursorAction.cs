...
namespace TSMapEditor.UI.CursorActions
{
    ...
    public class CalculateTiberiumValueCursorAction : CursorAction
    {
        ...
        public override string GetName() => "计算资源价值";
        ...
        public override void DrawPreview(Point2D cellCoords, Point2D cameraTopLeftPoint)
        {
            ...
            {
                DrawText(cellCoords, cameraTopLeftPoint, 60, -150, "单击以选择要计算的起始单元格.", Color.Yellow);
                return;
            }
            ...
            string text = "单击以选择新的起始单元格." + Environment.NewLine + Environment.NewLine +
                "当前面积的价值: " + GetTiberiumValue(startY, endY, startX, endX);
